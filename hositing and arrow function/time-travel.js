 ...
 */
    ...
    const travelDate = '2025-04-16';
    // when trying to change travelDate here, a SyntaxError is returned as travelDate has already been declared.

    const travelDate = '2024-03-15';
    travelDate = '2025-04-16';
    //when trying to change travelDate here, a TypeError is returned since travelDate is a const and reassignment is not allowed.
 ...
 */
    ...
    //undefined is returned because in javascript, variables(and function declarations) are moved to the of their scope. This means the variable timeMachineModel created but has not been initialized with the value 'T-800'
